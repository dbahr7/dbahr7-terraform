...
resource "aws_iam_policy" "parameter_store_access" {
  name = "ecs-${var.application}-${var.environment}-database_bridge_parameter_store_access"
...
resource "aws_iam_policy" "create_log_group" {
  name = "ecs-${var.application}-${var.environment}-database_bridge_create_log_group"
...
resource "aws_iam_policy" "task_policy" {
  name = "ecs-${var.application}-${var.environment}-database_bridge_task_policy"
...
resource "aws_iam_role" "exec_role" {
  name               = "${var.application}-${var.environment}-database_bridge_exec_role"
...
resource "aws_iam_role" "task_role" {
  name               = "${var.application}-${var.environment}-database_bridge_task_role"
  path               = "/ecs/${var.application}/"
  assume_role_policy = data.aws_iam_policy_document.ecs_assume_role.json
}
