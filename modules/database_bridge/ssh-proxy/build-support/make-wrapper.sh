# Helper script from nixpkgs with customization that adds $_WRAPPED_PROGRAM
# https://github.com/NixOS/nixpkgs/blob/3c5b297e07efa4acf0b6cfda82496063d0a70e8b/pkgs/build-support/setup-hooks/make-wrapper.sh
...
makeShellWrapper() {
    ...
    # Custom code: expose path to wrapped program
    echo "export _WRAPPED_PROGRAM=$original" >> "$wrapper"
