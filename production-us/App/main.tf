...
module "my_app_ecs" {
  ...
  site_name   = "US App Platform"
  server_name = "US.AppPlatform"

  dd_account_name              = local.dd_account_name
  datadog_log_forwarder_lambda = "datadog-forwarder-Forwarder-xxxxxxxxxxxx" # placeholder, update with actual lambda name
  database_monitoring_enabled  = true

  public_key = "ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAABAQC0000000000000000000000000000000000000000000000000...00000000000000000000000000000000000000 placeholder-key"
}
...
module "database_bridge" {
  ...
  public_key = "ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAABAQC00000000000000000000000000000000000000000000000000000...000000000000000000000000000000000 placeholder-key"
}
